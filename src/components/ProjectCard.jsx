...
const ProjectCard = ({ project }) => (
    <a key={project.id} href='#' className='flex flex-col h-[300px] w-[90%] sm:w-[55%] lg:w-[20%] justify-between bg-dark-purple-100 rounded-[3rem] 
          p-3 transition-all hover:scale-90'>
