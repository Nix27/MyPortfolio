...
const About = () => (
  <section className='lg:h-[100vh] flex flex-col lg:flex-row-reverse items-center justify-center lg:justify-between gap-5 px-10'>
    <div className='flex justify-center lg:w-[40%]'>
      <img src={profileImage} alt='profile image' className='rounded-[9.9375rem]' />
    </div>
    
    <div className='flex flex-col gap-2 lg:w-[50%]'>
      <h2 className='gradient-poppins-text text-[2.5rem]'>Hi, I'm Nikola</h2>
      <p className='gradient-poppins-text text-[1.2rem]'>
